...
type
  ...
  TVideoPositionuebergeben = PROCEDURE(VAR Position: Int64) OF OBJECT;
  TAudioplayersynchronisieren = FUNCTION: Boolean OF OBJECT;
  TAudioplayerPositionholen = FUNCTION: Int64 OF OBJECT;
...
FUNCTION BildPosition(IBildNr, BildPos: Int64; Position: Int64): Boolean;
...
FUNCTION Positionieren(Position: Int64; IFrame: Boolean = False): Integer;
FUNCTION Bildlesen(Position: Int64; IFrame: Boolean): PByteArray;
FUNCTION BMPBildlesen(Position: Int64; Weite: Integer; Positionwiederherstellen, IFrame: Boolean): TBitmap; OVERLOAD;
FUNCTION BMPBildlesen1(Datei: STRING; Liste, IndexListe: TListe; Position: Int64; Weite: Integer; Positionwiederherstellen, IFrame: Boolean): TBitmap; OVERLOAD;
      ...
      FINALLY
        ...
        BEGIN
          ...
          FINALLY
            ...
            ELSE
            BEGIN
  // SetDisplayMode sorgte für Bildschirmflackern, Danke an Jan Mühlendyck
{              TRY
...
BEGIN
  ...
  BEGIN
    ...
    SurfaceDesc.dwWidth:=720;                               // Videogröße
    SurfaceDesc.dwHeight:=576;
    TRY
      TRY
...
{0.7.2.1q6b ThreadProtection ende}
    VideoBildPosition := PositionAnfang + Int64(Dateieigenschaften.Frame) - 2;
...
//    BildanzeigeZeit : Integer;
    VideoBildPositionMillisek : Int64;
...
//  VideoabspielerMode := mpPaused;
  ...
  WHILE VideoabspielerMode = mpPlaying DO
    Application.ProcessMessages;                // warten bis der Thread steht
END;
