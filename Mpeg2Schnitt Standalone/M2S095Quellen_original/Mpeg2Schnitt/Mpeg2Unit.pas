...
//          IF AudioNullHeader.Framelaenge > 0 THEN
  ...
  //            Protokoll_Leerzeile_einfuegen;
              Protokoll_schreiben('Beginn Audioberechnung: ' + Schnittpunkt.AudioName + ' Schnittpunkt: ' + IntToStr(I + 1));
              Protokoll_schreiben('Bildlänge: ' + FloatToStr(Bildlaenge) + ' ms');
              Protokoll_schreiben('Audioframelänge: ' + FloatToStr(Audioheader.Framezeit) + ' ms');
              Protokoll_schreiben('Audiodateilänge: ' + IntToStr(Liste.Count - 2) + ' Frames');
              Protokoll_schreiben('Audiooffset: ' + IntToStr(Schnittpunkt.Audiooffset) + ' ms');
              Protokoll_schreiben('Audioversatz 1: ' + FloatToStr(Audioversatz) + ' ms');
              Protokoll_schreiben('Schnittpunkt Anfang: ' + FloatToStr(Schnittpunkt.Anfang * Bildlaenge) + ' ms');
              AnfangsIndex := Round(((Schnittpunkt.Anfang * Bildlaenge) + Audioversatz - Versatz - Schnittpunkt.Audiooffset) / Audioheader.Framezeit);
              Protokoll_schreiben('AnfangsIndex: ' + IntToStr(AnfangsIndex) + ' Frames');
              ...
              Protokoll_schreiben('Audioversatz 2: ' + FloatToStr(Audioversatz) + ' ms');
              Protokoll_schreiben('Schnittpunkt Ende + 1: ' + FloatToStr((Schnittpunkt.Ende + 1) * Bildlaenge) + ' ms');
              EndIndex := Round((((Schnittpunkt.Ende + 1) * Bildlaenge) - Audioversatz - Versatz - Schnittpunkt.Audiooffset) / Audioheader.Framezeit) - 1;
              Protokoll_schreiben('EndeIndex + 1: ' + IntToStr(EndIndex + 1) + ' Frames');
              ...
              Protokoll_schreiben('Audioversatz 3: ' + FloatToStr(Audioversatz) + ' ms');
  //            Protokoll_schreiben('Ende Audioberechnung');
...
//            Protokoll_Leerzeile_einfuegen;
            Protokoll_schreiben('Beginn Audioberechnung: ' + Schnittpunkt.AudioName + ' Schnittpunkt: ' + IntToStr(I + 1));
            Protokoll_schreiben('Bildlänge: ' + FloatToStr(Bildlaenge) + ' ms');
            Protokoll_schreiben('Audioframelänge: ' + FloatToStr(AudioNullHeader.Framezeit) + ' ms');
            Protokoll_schreiben('Leeres Audio wird geschrieben');
            Protokoll_schreiben('Audioversatz 1: ' + FloatToStr(Audioversatz) + ' ms');
            Protokoll_schreiben('Schnittpunkt Anfang: ' + FloatToStr(Schnittpunkt.Anfang * Bildlaenge) + ' ms');
