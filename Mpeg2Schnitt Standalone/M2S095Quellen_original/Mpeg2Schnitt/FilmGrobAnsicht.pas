...
type
  ...
  TBildzuBitmap = function(Position: Int64; Weite: Integer; Positionwiederherstellen, IFrame: Boolean): TBitmap of object; // neu Martin
  TPositionsetzen = procedure(Pos: Int64; verwendeUndo: Boolean = False) of object; // neu Martin
  ...
  TFilmGrobAnsichtFrm = class(TForm)
    ...
    Dummy: TPopupMenu;
    binaereSucheBtn1: TBitBtn;
    binaereSucheBtn2: TBitBtn;
...
//  binaereSucheBtn1 := TAlphaSpeedBtn.Create(Self).Replace(binaereSucheBtn1);
//  TAlphaSpeedBtn(binaereSucheBtn1).Glyph := nil;
  Bilderanzeigen;
end;
...
var
  ...
  function CreateGrobImageVonBildposition(Position:Int64; Zaehler:Integer; Poswiederher, IFrame:Boolean): integer;
  var
    IM: TMpegImage;
  begin
...
//      binaereSucheBtn1.Font.Color := ArbeitsumgebungObj.GrobansichtFarbeWerbung;
      binaereSucheBtn1.Font.Color := clRed;
