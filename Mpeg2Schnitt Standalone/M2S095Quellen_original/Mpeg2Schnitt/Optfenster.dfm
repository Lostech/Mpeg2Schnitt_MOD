object Optionenfenster: TOptionenfenster
  ...
  object OptionenSeiten: TPageControl
    ...
    Width = 581
    Height = 402
    ActivePage = OptionenVideoAudioSchnittseiteTab
    HotTrack = True
    MultiLine = True
    TabHeight = 20
    TabOrder = 5
    ...
    object OptionenVideoAudioSchnittseiteTab: TTabSheet
      ...
      object OptionenVideoschnitt_: TGroupBox
        ...
        object OptionenZusammenhaengendeSchnitteberechnenBox: TCheckBox
          Left = 12
          Top = 120
          Width = 265
          Height = 17
          Caption = 'zusammenh'#228'ngende Schnitte berechnen'
          TabOrder = 11
        end
      end
      ...
      object OptionenSchnittAllgemein_: TGroupBox
        ...
        object OptionenSpeicherplatzpruefenBox: TCheckBox
          Left = 12
          Top = 76
          Width = 265
          Height = 17
          Caption = 'Speicherplatz pr'#252'fen'
          TabOrder = 3
        end
      end
    end
    ...
    object OptionenNavigationsseiteTab: TTabSheet
      ...
      object OptionenVideoeigenschaftenaktBox: TCheckBox
        Left = 22
        Top = 186
        Width = 297
        Height = 17
        Caption = 'Videoeigenschaften aktualisieren'
        TabOrder = 6
      end
      object OptionenAudioeigenschaftenaktBox: TCheckBox
        Left = 22
        Top = 210
        Width = 297
        Height = 17
        Caption = 'Audioeigenschaften aktualisieren'
        TabOrder = 7
      end
    end
