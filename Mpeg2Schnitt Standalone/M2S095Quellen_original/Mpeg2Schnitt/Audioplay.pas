...
PROCEDURE AudioplayerPosition_setzen(Pos: Int64);

FUNCTION AudioplayerPosition_holen: Int64;
...
PROCEDURE AudioplayerMCIPosition_setzen(Pos: Int64);
BEGIN
  IF Audioplayer_OK THEN
  BEGIN
    TRY
...
FUNCTION AudioplayerMCIPosition_holen: Int64;
BEGIN
  IF Audioplayer_OK THEN
  BEGIN
    TRY
