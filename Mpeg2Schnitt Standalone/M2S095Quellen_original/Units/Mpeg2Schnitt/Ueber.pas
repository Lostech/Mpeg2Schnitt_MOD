...
begin
  ...
  BEGIN
    ...
    Versi.Caption := '';
    Copyright.Caption := '(2003-2010) Martin Dienert';
    Internetseite.Caption := 'mpeg2schnitt.mdienert.de';
    E_Mail.Caption := 'mpeg2schnitt@mdienert.de';
  END;
  FLizensiert := False;
...
begin
  ShellExecute(Application.Handle, 'open', PCHar('http://' + Internetseite.Caption), nil, nil, SW_ShowNormal);
end;
