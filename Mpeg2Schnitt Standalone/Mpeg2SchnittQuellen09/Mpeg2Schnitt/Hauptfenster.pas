...
type
  ...
  private
    ...
    SchiebereglerMax : LongInt;
    SchiebereglerPosition : LongInt;
    StandBildPosition : LongInt;
    SchiebereglerPosition_merken,
    SpieleVonBisPosition : LongInt;
...
//    BilderProSek : Real;
    ...
    FUNCTION Schnittpunktmoeglich(Pos: LongInt): Integer;
    PROCEDURE Cutmoeglich(Pos: LongInt);
    ...
    FUNCTION Schnittpunktfuellen(Schnitt : TSchnittpunkt; Videoknoten, Audioknoten: TTreeNode; PositionIn, PositionOut: LongInt; BilderProsek: Real; Liste, IndexListe: TListe): Integer;
    ...
    FUNCTION SchnittgroesseberechnenVideoaktiv(Liste, IndexListe: TListe; Anfangsbild, Endbild: LongInt): Int64;
    FUNCTION SchnittgroesseberechnenVideo(Videoname: STRING; Anfangsbild, Endbild: LongInt): Int64;
    FUNCTION SchnittgroesseberechnenVideo_Knoten(Knoten: TTreeNode; Anfangsbild, Endbild: LongInt; HListe: TListe = NIL; HIndexListe: TListe = NIL): Int64;
    FUNCTION SchnittgroesseberechnenVideo_akt(Anfangsbild, Endbild: LongInt): Int64;
    PROCEDURE SchnittgroesseNeuberechnenVideo(Knoten: TTreeNode);
    FUNCTION SchnittgroesseberechnenAudioaktiv(AudioHeader : TAudioHeader; Anfangsbild, Endbild: LongInt; Bildlaenge: Real): Int64;
    FUNCTION SchnittgroesseberechnenAudio(Audioname: STRING; Anfangsbild, Endbild: LongInt; Bildlaenge: Real): Int64;
    FUNCTION SchnittgroesseberechnenAudio_Knoten(Knoten: TTreeNode; Anfangsbild, Endbild: LongInt; Framerate: Real): Int64;
    FUNCTION SchnittgroesseberechnenAudio_akt(Anfangsbild, Endbild: LongInt): Int64;
    ...
    FUNCTION AudioplayerPositionPlusOffset: LongInt;
    PROCEDURE Positionsanzeige(VAR Position: LongInt);
//    PROCEDURE AbspielenStoppen;
    PROCEDURE Anzeigeaktualisieren(Pos: LongInt);
    PROCEDURE GehezuVideoPosition(Position: LongInt);
    ...
    PROCEDURE SchiebereglerMax_setzen(Pos: LongInt);
    PROCEDURE SchiebereglerSelStart_setzen(Pos: LongInt);
    PROCEDURE SchiebereglerSelEnd_setzen(Pos: LongInt);
    PROCEDURE Tastenbeschriftung(Taste: TSpeedButton; Teil1, Teil2: STRING);
    PROCEDURE SetSelectionLength;
    PROCEDURE SetPositionIn(Pos: LongInt; verwendeUndo: Boolean = False);
    PROCEDURE SetPositionOut(Pos: LongInt; verwendeUndo: Boolean = False);
...
FUNCTION FramesToZeit(Frames: LongInt; BilderProSek: Real): TZeitCode;
BEGIN
...
FUNCTION ZeitToFrames(Zeit: TZeitCode; BilderProSek: Real): LongInt;
BEGIN
  IF BilderProSek < 1 THEN
    BilderProSek := 25;
  WITH Zeit DO
...
FUNCTION mSekToZeit(mSek: LongInt): TZeitCode;
BEGIN
  WITH Result DO
  BEGIN
    IF mSek < 0 THEN
...
FUNCTION ZeitTomSek(Zeit: TZeitCode; BilderProSek: Real): LongInt;
BEGIN
  IF BilderProSek < 1 THEN
    BilderProSek := 25;
  WITH Zeit DO
...
FUNCTION BildTypausListe(Liste: TList; Pos: LongInt): Char;
...
{  WindowState := wsNormal;
  ...
  IF ArbeitsumgebungObj.ZweiVideofenster THEN
...
PROCEDURE TMpegEdit.Anzeigeaktualisieren(Pos: LongInt);
...
FUNCTION TMpegEdit.AudioplayerPositionPlusOffset: LongInt;
BEGIN
...
PROCEDURE TMpegEdit.Positionsanzeige(VAR Position: LongInt);
...
begin
  ...
  BEGIN
    ...
    IF (TAbspielmode(AudioPlayerMode) = mpPlaying) AND (Position > Round(Audiozahl / Bildlaenge) - 2) THEN
...
FUNCTION TMpegEdit.Schnittpunktmoeglich(Pos: LongInt): Integer;
...
PROCEDURE TMpegEdit.Cutmoeglich(Pos: LongInt);
...
PROCEDURE TMpegEdit.GehezuVideoPosition(Position: LongInt);
...
PROCEDURE TMpegEdit.SetPositionIn(Pos: LongInt; verwendeUndo: Boolean = False);
...
PROCEDURE TMpegEdit.SetPositionOut(Pos: LongInt; verwendeUndo: Boolean = False);
...
FUNCTION TMpegEdit.Schnittpunktfuellen(Schnitt : TSchnittpunkt;
                                       ...
                                       PositionIn, PositionOut: LongInt;
                                       BilderProsek: Real;
...
begin
  ...
  ELSE
    IF SchiebereglerPosition <> PositionIn THEN
      SchiebereglerPosition_setzen(PositionIn, True);
end;
...
begin
  ...
  ELSE
    IF SchiebereglerPosition <> PositionOut THEN
      SchiebereglerPosition_setzen(PositionOut, True);
end;
...
FUNCTION TMpegEdit.SchnittgroesseberechnenVideoaktiv(Liste, IndexListe: TListe; Anfangsbild, Endbild: LongInt): Int64;
BEGIN
...
FUNCTION TMpegEdit.SchnittgroesseberechnenVideo(Videoname: STRING; Anfangsbild, Endbild: LongInt): Int64;
...
FUNCTION TMpegEdit.SchnittgroesseberechnenVideo_Knoten(Knoten: TTreeNode; Anfangsbild, Endbild: LongInt; HListe: TListe = NIL; HIndexListe: TListe = NIL): Int64;
...
FUNCTION TMpegEdit.SchnittgroesseberechnenVideo_akt(Anfangsbild, Endbild: LongInt): Int64;
BEGIN
{  IF aktVideodatei = '' THEN
    Result := 0
  ELSE
...
FUNCTION TMpegEdit.SchnittgroesseberechnenAudioaktiv(AudioHeader : TAudioHeader; Anfangsbild, Endbild: LongInt; Bildlaenge: Real): Int64;
BEGIN
  IF Assigned(AudioHeader) THEN
...
FUNCTION TMpegEdit.SchnittgroesseberechnenAudio(Audioname: STRING; Anfangsbild, Endbild: LongInt; Bildlaenge: Real): Int64;
...
FUNCTION TMpegEdit.SchnittgroesseberechnenAudio_Knoten(Knoten: TTreeNode; Anfangsbild, Endbild: LongInt; Framerate: Real): Int64;
...
FUNCTION TMpegEdit.SchnittgroesseberechnenAudio_akt(Anfangsbild, Endbild: LongInt): Int64;
BEGIN
  IF Assigned(aktAudioknoten) THEN
...
FUNCTION TMpegEdit.BMPBildlesen(Position: LongInt; Weite: Integer; Positionwiederherstellen, IFrame: Boolean): TBitmap;
BEGIN
  Result := Mpeg2Fenster.BMPBildlesen(Position, Weite, Positionwiederherstellen, IFrame);
END;

PROCEDURE TMpegEdit.SchiebereglerPosition_setzen(Pos: LongInt; verwendeUndo: Boolean = False);
BEGIN
...
PROCEDURE TMpegEdit.SchiebereglerMax_setzen(Pos: LongInt);
BEGIN
...
PROCEDURE TMpegEdit.SchiebereglerSelStart_setzen(Pos: LongInt);
BEGIN
...
PROCEDURE TMpegEdit.SchiebereglerSelEnd_setzen(Pos: LongInt);
BEGIN
...
FUNCTION Schnittanpassen(Schnittpunkt: TSchnittpunkt; Anfang: Boolean = True): LongInt;
...
FUNCTION Projektpruefen(Projektname: STRING): Integer;

VAR Projektdatei : TStringList;

BEGIN
  IF FileExists(Projektname) THEN
  BEGIN
    Projektdatei := TStringList.Create;
    TRY
      Projektdatei.LoadFromFile(Projektname);
      IF LeftStr(Projektdatei.Strings[Projektdatei.Count - 1], 13) = 'Fehlernummer=' THEN
          ...
          TRY
            ...
            BEGIN
              ...
              BEGIN
                ...
                BEGIN                                                                   // SchnittTool erfolgreich aufgerufen
                  Fehlernummer := Projektpruefen(VideoProjekt + '.m2e');
                  Fehlernummer := Projektpruefen(AudioProjekt + '.m2e');
                END
                ELSE
...
//  Schnittliste.Canvas.Rectangle(Rect);
  ...
  BEGIN
    ...
    BEGIN
      X := X + Schnittliste.Canvas.TextWidth(HString) + 3;
          ...
          BEGIN
            ...
            BEGIN
              ...
              BEGIN
                AbspielModus := False;
                PlayerPause;
                WHILE VideoabspielerMode = mpPlaying DO
                  Application.ProcessMessages;                // warten bis das aktuelle Bild fertig ist
              END;
  ...
  BEGIN
    ...
    TRY
      ...
      BEGIN
        ...
        IF Index < AudioListe.Count THEN
