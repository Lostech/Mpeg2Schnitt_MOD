...
//        Exit;
    ...
    {$ENDIF}
      IF NOT Assigned(DirectSoundEnumerate) THEN          // Martin
        Exit;

      DirectSoundCaptureCreate := GetProcAddress(DSoundDLL,'DirectSoundCaptureCreate');
      IF NOT Assigned(DirectSoundCaptureCreate) THEN      // Martin
        Exit;
      DirectSoundCaptureCreate8 := GetProcAddress(DSoundDLL,'DirectSoundCaptureCreate8');
      IF NOT Assigned(DirectSoundCaptureCreate8) THEN     // Martin
        Exit;
    ...
    {$ENDIF}
      IF NOT Assigned(DirectSoundCaptureEnumerate) THEN   // Martin
        Exit;
      DirektSound_OK := True;
    end;
  end;
