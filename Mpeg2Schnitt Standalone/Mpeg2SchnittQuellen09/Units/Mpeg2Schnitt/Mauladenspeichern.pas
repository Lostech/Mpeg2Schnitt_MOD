...
//    IniFile : TIniFile;
    ...
    PROCEDURE Arbeitsumgebunganpassen(Name: STRING);
...
PROCEDURE TArbeitsumgebung.Arbeitsumgebunganpassen(Name: STRING);
...
BEGIN
  ...
  TRY
    MauVersion := IniFile.ReadInteger('Allgemein', 'ArbeitsumgebungsVersion', 0);
    IF MauVersion < 1 THEN
    BEGIN
      Arbeitsumgebungladen(Name);
      Arbeitsumgebungspeichern(Name);
    END;
  FINALLY
    IniFile.Free;
  END;
...
// ------------ Verzeichnisse --------------------------------
    ...
    ProjektVerzeichnis := mitPathtrennzeichen(absolutPathAppl(IniFile.ReadString('Verzeichnisse', 'ProjektVerzeichnis', ''), ApplikationsName, True));
    ...
    VorschauVerzeichnis := mitPathtrennzeichen(absolutPathAppl(IniFile.ReadString('Verzeichnisse', 'VorschauVerzeichnis', ''), ApplikationsName, True));
    ZwischenVerzeichnis := mitPathtrennzeichen(absolutPathAppl(IniFile.ReadString('Verzeichnisse', 'ZwischenVerzeichnis', ''), ApplikationsName, True));
// ------------ Dateinamen/Endungen --------------------------------
...
//    Framegenauschneiden := IniFile.ReadBool('Videoschnitt', 'FramegenauschneidenX', True);
...
// ------------ Ein-/Ausgabeprogramme --------------------
    ...
    Encoderdatei := absolutPathAppl(IniFile.ReadString('Encoder', 'Encoderdatei', ''), ApplikationsName, False);
    Ausgabedatei := absolutPathAppl(IniFile.ReadString('Ausgabe', 'Ausgabedatei', ''), ApplikationsName, False);
// ------------ Effekte --------------------
    VideoEffektverzeichnis := absolutPathAppl(IniFile.ReadString('Effekte', 'VideoEffektverzeichnis', ''), ApplikationsName, True);
    AudioEffektverzeichnis := absolutPathAppl(IniFile.ReadString('Effekte', 'AudioEffektverzeichnis', ''), ApplikationsName, True);
    Effektvorgabedatei := absolutPathAppl(IniFile.ReadString('Effekte', 'Effektvorgabedatei', ''), ApplikationsName, False);
...
// ------------ Verzeichnisse --------------------------------
      ...
      BEGIN
        ...
        ProjektVerzeichnis := mitPathtrennzeichen(absolutPathAppl(IniFile.ReadString('Allgemein', 'ProjektVerzeichnis', ''), ApplikationsName, True));
        ...
        VorschauVerzeichnis := mitPathtrennzeichen(absolutPathAppl(IniFile.ReadString('Allgemein', 'VorschauVerzeichnis', ''), ApplikationsName, True));
      END;
// ------------ Dateinamen/Endungen --------------------------------
...
PROCEDURE TArbeitsumgebung.ProgrammPositionspeichern(Name: STRING);
...
PROCEDURE TArbeitsumgebung.SchnittToolPositionspeichern(Name: STRING);
