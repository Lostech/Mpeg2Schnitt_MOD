...
FUNCTION Parameterlesen(Projektliste: TStringList; ProjektInfo: TProjektInfo; VAR ProgrammPosition: TRect): Integer;
          ...
          ELSE
            ...
            ELSE
              ...
              ELSE
                ...
                END
                ELSE
                  IF UpperCase(LeftStr(ParamStr(I), 3)) = '/PP' THEN            // extra Projektname
                  BEGIN
