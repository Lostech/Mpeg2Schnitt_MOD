...
FUNCTION Scriptstarten(Ausgabescript: TStrings; Variablen: TStrings; Scriptname: STRING = ''; Marke: STRING = ':all'): Integer; OVERLOAD;
FUNCTION Scriptstarten(Ausgabedatei: STRING; Variablen: TStrings; Scriptname: STRING = ''; Marke: STRING = ':all'): Integer; OVERLOAD;
    ...
    BEGIN
      ...
      BEGIN
        ...
        BEGIN
          ...
          IF HString3 = '' THEN
            HString3 := ':all';
          Result := Scriptstarten(HString, Variablen, HString2, HString3);
//          Result := Scriptstarten(HString, Variablen, Scriptname, Marke);
        END
        ELSE
...
BEGIN
  ...
  BEGIN
    ...
    TRY
      ...
      Result := Scriptstarten(AusgabeListe, Variablen, Scriptname, Marke);
    FINALLY
      AusgabeListe.Free;
    END;
  END
